...
class AMPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AMPM")
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(2*3.142/100, 4, True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 495000, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_arg_0, 0), (self.dc_blocker_xx_0_0, 0))
        ...
        self.connect((self.blocks_file_source_0, 0), (self.hilbert_fc_1, 0))
        ...
        self.connect((self.dc_blocker_xx_0_0, 0), (self.iir_filter_xxx_0, 0))
        ...
        self.connect((self.hilbert_fc_1, 0), (self.digital_costas_loop_cc_0, 0))
        self.connect((self.iir_filter_xxx_0, 0), (self.rational_resampler_xxx_0_0, 0))
...
def main(top_block_cls=AMPM, options=None):
