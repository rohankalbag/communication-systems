...
class desensitisation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "desensitisation")
        ...
        # Variables
        ##################################################
        self.slide = slide = 10e-6
        self.samp_rate = samp_rate = 4300000
        self.freq = freq = 0.5e6
        self.amp = amp = 0.01

        ##################################################
        # Blocks
        ##################################################
        self._slide_range = Range(0, 30e-3, 10e-6, 10e-6, 200)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(-1/(2*0.025))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(slide)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/rohan/Desktop/EE340/Lab6/Input.bin', True, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.Av, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Av, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_slide(self, slide):
        self.slide = slide
        self.blocks_multiply_const_vxx_0.set_k(self.slide)
...
def main(top_block_cls=desensitisation, options=None):
