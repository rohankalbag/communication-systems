...
class part1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccf(sps, [1])
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.blocks_null_sink_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.blocks_add_xx_1_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_delay_0_0_0_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_delay_0_0_0_1_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_delay_0_0_1_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_delay_0_0_2_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_add_xx_1_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_delay_0_0_0_0_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_delay_0_0_0_1, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_delay_0_0_1_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_delay_0_0_2, 0))
