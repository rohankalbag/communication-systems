...
class part4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(200)
        ...
        self.blocks_delay_0_0_2_0 = blocks.delay(gr.sizeof_float*1, 1*(20*sps))
    ...
    def set_sps(self, sps):
        ...
        self.blocks_delay_0_0_2_0.set_dly(1*(20*self.sps))
