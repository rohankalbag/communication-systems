...
class part4_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "part4_2")
        ...
        # Blocks
        ##################################################
        self._b4_range = Range(0, 1, 1e-4, 0.0625, 200)
        self._b4_win = RangeWidget(self._b4_range, self.set_b4, "'b4'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b4_win)
        self._b3_range = Range(-1, 0, 1e-4, -0.125, 200)
        ...
        self._b2_range = Range(0, 1, 1e-3, 0.25, 200)
        ...
        self._b1_range = Range(-1, 0, 1e-3, -0.5, 200)
        ...
        self.blocks_multiply_const_vxx_0_0_3_0 = blocks.multiply_const_ff(b1)
        self.blocks_multiply_const_vxx_0_0_3 = blocks.multiply_const_ff(b1)
        self.blocks_multiply_const_vxx_0_0_2_0_0 = blocks.multiply_const_ff(b4)
        self.blocks_multiply_const_vxx_0_0_2_0 = blocks.multiply_const_ff(b4)
        self.blocks_multiply_const_vxx_0_0_1_0_0 = blocks.multiply_const_ff(b3)
        self.blocks_multiply_const_vxx_0_0_1_0 = blocks.multiply_const_ff(b3)
        self.blocks_multiply_const_vxx_0_0_0_0_0 = blocks.multiply_const_ff(b2)
        self.blocks_multiply_const_vxx_0_0_0_0 = blocks.multiply_const_ff(b2)
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_1_1, 0))
        ...
        self.connect((self.blocks_abs_xx_0, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.blocks_abs_xx_0, 0), (self.blocks_multiply_xx_2, 1))
        ...
        self.connect((self.blocks_add_xx_1_0_0, 0), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_add_xx_1_1, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.blocks_complex_to_float_1, 1), (self.blocks_add_xx_1, 1))
        self.connect((self.blocks_complex_to_float_1, 0), (self.blocks_add_xx_1_1, 1))
    ...
    def set_b4(self, b4):
        self.b4 = b4
        self.blocks_multiply_const_vxx_0_0_2_0.set_k(self.b4)
        self.blocks_multiply_const_vxx_0_0_2_0_0.set_k(self.b4)
    ...
    def set_b3(self, b3):
        self.b3 = b3
        self.blocks_multiply_const_vxx_0_0_1_0.set_k(self.b3)
        self.blocks_multiply_const_vxx_0_0_1_0_0.set_k(self.b3)
    ...
    def set_b2(self, b2):
        self.b2 = b2
        self.blocks_multiply_const_vxx_0_0_0_0.set_k(self.b2)
    ...
    def set_b1(self, b1):
        self.b1 = b1
        self.blocks_multiply_const_vxx_0_0_3.set_k(self.b1)
        self.blocks_multiply_const_vxx_0_0_3_0.set_k(self.b1)




def main(top_block_cls=part4_2, options=None):
