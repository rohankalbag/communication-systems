...
class dsbsc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "DSB-SC", catch_exceptions=True)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_freq_sink_x_0_1_0_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.qtgui_freq_sink_x_0_1_0_0.set_frequency_range(0, self.audio_rate)
