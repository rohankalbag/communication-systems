...
class ssbscusb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB-SC-USB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB-SC-USB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssbscusb")
        ...
        self.analog_sig_source_x_1_2 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_1_1 = analog.sig_source_c(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1_2, 0), (self.blocks_multiply_xx_1, 1))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
    ...
    def set_quadrature_rate(self, quadrature_rate):
        ...
        self.analog_sig_source_x_1_1.set_sampling_freq(self.quadrature_rate)
        self.analog_sig_source_x_1_2.set_sampling_freq(self.quadrature_rate)
...
def main(top_block_cls=ssbscusb, options=None):
