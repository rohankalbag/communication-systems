...
class ssbsclsb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB-SC-LSB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB-SC-LSB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssbsclsb")
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 90)
        ...
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=ssbsclsb, options=None):
