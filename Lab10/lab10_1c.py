...
class lab10_1c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab10_1c")
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_float*1, '127.0.0.1', 12345, 100, True)
...
def main(top_block_cls=lab10_1c, options=None):
