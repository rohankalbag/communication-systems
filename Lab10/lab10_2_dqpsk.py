...
class lab10_2_dqpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab10_2_dqpsk")
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 5 + 7*8)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/rohan/Desktop/EE340/Lab10/QPSKRecieved.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(2e6, analog.GR_SIN_WAVE, 100e3, -1, 0, 0)
        ...
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=lab10_2_dqpsk, options=None):
