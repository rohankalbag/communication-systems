...
class dsbsc(gr.top_block, Qt.QWidget):
    ...
    def set_q_rate(self, q_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.q_rate, 12000, 600, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.q_rate)
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.q_rate)
