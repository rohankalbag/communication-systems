...
class freqmod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "freqmod")
        ...
        self.quad_rate = quad_rate = int(480e3)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(quad_rate, analog.GR_COS_WAVE, 100e3, 1, 0, 0)
...
def main(top_block_cls=freqmod, options=None):
